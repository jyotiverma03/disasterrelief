...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_BASEMODEL_LIST actions', async () => {
    ...
    it('dispatches FETCH_BASEMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_BASEMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_BASEMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_BASEMODEL actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_BASEMODEL actions', async () => {
      const expectedActions = [
        {
