...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ASSISTANCE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ASSISTANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ASSISTANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ASSISTANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ASSISTANCE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ASSISTANCE actions', async () => {
      const expectedActions = [
        {
