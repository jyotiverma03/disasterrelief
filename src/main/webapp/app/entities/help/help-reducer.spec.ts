...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './help.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_HELP_LIST actions', async () => {
    ...
    it('dispatches FETCH_HELP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_HELP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_HELP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_HELP actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_HELP actions', async () => {
      const expectedActions = [
        {
