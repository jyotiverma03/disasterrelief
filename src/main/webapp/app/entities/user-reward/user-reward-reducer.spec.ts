...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_USERREWARD_LIST actions', async () => {
    ...
    it('dispatches FETCH_USERREWARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_USERREWARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_USERREWARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_USERREWARD actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_USERREWARD actions', async () => {
      const expectedActions = [
        {
