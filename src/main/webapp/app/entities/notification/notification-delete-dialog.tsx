...
export const NotificationDeleteDialog = (props: RouteComponentProps<{ id: string }>) => {
  ...
  return (
    <Modal isOpen toggle={handleClose}>
      ...
      <ModalBody id="disasterreliefApp.notification.delete.question">
        <Translate contentKey="disasterreliefApp.notification.delete.question" interpolate={{ id: notificationEntity.id }}>
